...
!function (e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.axios = t() : e.axios = t(); }(this, function () {
    return function (e) { function t(r) { if (n[r])
        return n[r].exports; var o = n[r] = { exports: {}, id: r, loaded: !1 }; return e[r].call(o.exports, o, o.exports, t), o.loaded = !0, o.exports; } var n = {}; return t.m = e, t.c = n, t.p = "", t(0); }([function (e, t, n) { e.exports = n(1); }, function (e, t, n) {
            "use strict";
            function r(e) { var t = new s(e), n = i(s.prototype.request, t); return o.extend(n, s.prototype, t), o.extend(n, t), n; }
            ...
            function v(e, t) { if (null !== e && "undefined" != typeof e)
            ...
            function x() { function e(e, n) { "object" == typeof t[n] && "object" == typeof e ? t[n] = x(t[n], e) : t[n] = e; } for (var t = {}, n = 0, r = arguments.length; n < r; n++)
                v(arguments[n], e); return t; }
            ...
            r.prototype.request = function (e) { "string" == typeof e && (e = i.merge({ url: arguments[0] }, arguments[1])), e = i.merge(o, { method: "get" }, this.defaults, e), e.method = e.method.toLowerCase(); var t = [u, void 0], n = Promise.resolve(e); for (this.interceptors.request.forEach(function (e) { t.unshift(e.fulfilled, e.rejected); }), this.interceptors.response.forEach(function (e) { t.push(e.fulfilled, e.rejected); }); t.length;)
                n = n.then(t.shift(), t.shift()); return n; }, i.forEach(["delete", "get", "head", "options"], function (e) { r.prototype[e] = function (t, n) { return this.request(i.merge(n || {}, { method: e, url: t })); }; }), i.forEach(["post", "put", "patch"], function (e) { r.prototype[e] = function (t, n, r) { return this.request(i.merge(r || {}, { method: e, url: t, data: n })); }; }), e.exports = r;
        }, function (e, t, n) {
            "use strict";
            ...
            var i = n(2), s = n(7), u = { "Content-Type": "application/x-www-form-urlencoded" }, a = { adapter: o(), transformRequest: [function (e, t) { return s(t, "Content-Type"), i.isFormData(e) || i.isArrayBuffer(e) || i.isBuffer(e) || i.isStream(e) || i.isFile(e) || i.isBlob(e) ? e : i.isArrayBufferView(e) ? e.buffer : i.isURLSearchParams(e) ? (r(t, "application/x-www-form-urlencoded;charset=utf-8"), e.toString()) : i.isObject(e) ? (r(t, "application/json;charset=utf-8"), JSON.stringify(e)) : e; }], transformResponse: [function (e) { if ("string" == typeof e)
                        try {
                            e = JSON.parse(e);
                        }
                        catch (e) { } return e; }], timeout: 0, xsrfCookieName: "XSRF-TOKEN", xsrfHeaderName: "X-XSRF-TOKEN", maxContentLength: -1, validateStatus: function (e) { return e >= 200 && e < 300; } };
            ...
            } if (l.open(e.method.toUpperCase(), i(e.url, e.params, e.paramsSerializer), !0), l.timeout = e.timeout, l[h] = function () { if (l && (4 === l.readyState || m) && (0 !== l.status || l.responseURL && 0 === l.responseURL.indexOf("file:"))) {
            ...
            } if ("setRequestHeader" in l && r.forEach(d, function (e, t) { "undefined" == typeof p && "content-type" === t.toLowerCase() ? delete d[t] : l.setRequestHeader(t, e); }), e.withCredentials && (l.withCredentials = !0), e.responseType)
                try {
            ...
            function r(e) { for (var t, r, i = String(e), s = "", u = 0, a = o; i.charAt(0 | u) || (a = "=", u % 1); s += a.charAt(63 & t >> 8 - u % 1 * 8)) {
            ...
            "use strict";
            var r = n(2);
            e.exports = r.isStandardBrowserEnv() ? function () { return { write: function (e, t, n, o, i, s) { var u = []; u.push(e + "=" + encodeURIComponent(t)), r.isNumber(n) && u.push("expires=" + new Date(n).toGMTString()), r.isString(o) && u.push("path=" + o), r.isString(i) && u.push("domain=" + i), s === !0 && u.push("secure"), document.cookie = u.join("; "); }, read: function (e) { var t = document.cookie.match(new RegExp("(^|;\\s*)(" + e + ")=([^;]*)")); return t ? decodeURIComponent(t[3]) : null; }, remove: function (e) { this.write(e, "", Date.now() - 864e5); } }; }() : function () { return { write: function () { }, read: function () { return null; }, remove: function () { } }; }();
        }, function (e, t, n) {
            "use strict";
            ...
            "use strict";
            function r(e) { if ("function" != typeof e)
            ...
            r.prototype.throwIfRequested = function () { if (this.reason)
                throw this.reason; }, r.source = function () { var e, t = new r(function (t) { e = t; }); return { token: t, cancel: e }; }, e.exports = r;
        }, function (e, t) {
            "use strict";
 ...
 * Usage:
 * ![soundcloud audio][http://youtu.be/dQw4w9WgXcQ]
 *
 * or
 *
 * ![soundcloud audio][1]
...
(function (extension) {
    ...
    var wrapper = function (children) {
        return '<%4%6%7>' + children + '</%4>';
    }, imgRegex = /(?:<p>)?<img.*?src="(.+?)"(.*?)\/?>(?:<\/p>)?/gi, fullSoundcloudRegex = /(?:(?:https?:)?(?:\/\/)?)(?:(?:www)?\.)?soundcloud\.(?:.+?)\/([a-zA-Z0-9_-]+\/[a-zA-Z0-9_-]+)/i, shortSoundcloudRegex = /(?:(?:https?:)?(?:\/\/)?)?snd\.sc\/([a-zA-Z0-9_-]{7})/i;
    // url to request
    // http://soundcloud.com/oembed?format=js&url=https://soundcloud.com/uiceheidd/robbery&iframe=true
    /**
     * Replace with soundcloud iframes
     */
    showdown.extension('soundcloud', function () {
        return [
            {
                ...
                filter: function (text, converter, options) {
                    var tag, wrapperEl, wrapperId, wrapperClass, url;
                    return text.replace(imgRegex, function (match, originalUrl, rest) {
                        if ((url = shortSoundcloudRegex.exec(originalUrl)) || (url = fullSoundcloudRegex.exec(originalUrl))) {
                            const link = '<a href="' + url[0] + '" target="_blank">' + url[0] + '</a>';
                            if (options['sc-useWrapper']) {
                                tag = wrapper(link);
                                if (!options['sc-wrapperEl']) {
                                    wrapperEl = 'div';
                                }
                                else {
                                    wrapperEl = options['sc-wrapperEl'];
                                }
                                if (options['sc-enableWrapperClass']) {
                                    if (options['sc-wrapperClass']) {
                                        wrapperClass = options['sc-wrapperClass'];
                                    }
                                    else {
                                        wrapperClass = 'showdown-soundcloud-embed-wrapper';
                                    }
                                }
                                if (options['sc-enableWrapperId']) {
                                    if (options['sc-wrapperId']) {
                                        wrapperId = options['sc-wrapperId'];
                                    }
                                    else {
                                        wrapperId = 'showdown-soundcloud-embed-wrapper';
                                    }
                                }
                            }
                            else {
                            ...
                            return tag.replace(/%4/g, wrapperEl)
